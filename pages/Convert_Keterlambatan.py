...
"ACCOUNT EXE.", "BAAN", "CRUSHER", "DATA ENTRY", "DIE CUT", "DIE MAKING",
"DOCUMENT CONTRO", "DRIVER", "EHS", "EPTE", "EXPEDISI", "FIN & ACC",
"FINISH GOOD", "FOCUSSIGHT", "FOLD & GLUE", "GA", "HIGH FREQ",
"HOT STAMPING B", "I.E", "INJEC MOULDING", "INJECT MOULDING", "J HOCK",
"JOIN MANUAL", "LABORATORIUM", "LAMINATING", "LEAN", "LITHONG", "LOGISTIK",
"MAINTENANCE", "MARKETING", "MASTER CARTON", "MASTER KARTON", "MIXING",
"MOLD KEEPER", "MOLD SETTER", "NTP", "P. CONTROL", "POLAR", "PON HANDLE",
"PPIC", "PREPRESS", "PRINTING", "PROD.ENGINEERI", "PROD.INTEGRITY",
"PROOFING", "PURCHASING", "QC INCOMING", "QC LAB", "QC LBO MJD",
"QC OUTGOING", "QC PROCESS", "QUALITY", "QUALITY CONTROL",
"QUALITY LBO MJD", "QUALITY SYISTEM", "RAW MATERIAL", "RECEPSIONIS",
"RIGID BOX", "SABLON AUTOMATI", "SABLON SEMI AUT", "SEALING", "SECURITY",
"SHEETER", "SHEETER BOARD", "SHEETER PVC", "SILK SCREEN", "SLITTER",
"SLITTER PVC", "SORTIR 1", "SORTIR HOTWELLS", "SORTIR HW", "SORTIR MJS",
"UV HOCK", "UV HOOK", "VACUUM FORMING", "VARNISH", "W. PATCHING", "WH",
"WP ESATEC", "WP ESTATE", "WP HOTWHEELS", "WP KOPEK", "SYSTEM DEVP", "SYSTEM DEV",
"SALES ADMIN", "SORTIR 2"
